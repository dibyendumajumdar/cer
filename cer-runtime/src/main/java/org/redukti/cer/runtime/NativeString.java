...
import static org.redukti.cer.runtime.ScriptRuntime.rangeError;
import static org.redukti.cer.runtime.ScriptRuntimeES6.requireObjectCoercible;
...
final class NativeString extends IdScriptableObject {
    ...
    private static CharSequence js_raw(Context cx, Scriptable scope, Object[] args) {
        ...
        if (rawLength > Integer.MAX_VALUE) {
            throw rangeError("raw.length > " + Integer.toString(Integer.MAX_VALUE));
        }

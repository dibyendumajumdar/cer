...
public class RegExpImpl implements RegExpProxy {
    ...
    @Override
    public Object compileRegExp(RuntimeContext rcx, String source, String flags) {
        Context cx = (Context) rcx;
        return NativeRegExp.compileRE(cx, source, flags, false);
    }

    @Override
    public Scriptable wrapRegExp(RuntimeContext rcx, Scriptable scope, Object compiled) {
        Context cx = (Context) rcx;
    ...
    public Object action(
            RuntimeContext rcx, Scriptable scope, Scriptable thisObj, Object[] args, int actionType) {
        Context cx = (Context) rcx;
     ...
     */
    @Override
    public Object js_split(RuntimeContext rcx, Scriptable scope, String target, Object[] args) {
        Context cx = (Context)rcx;

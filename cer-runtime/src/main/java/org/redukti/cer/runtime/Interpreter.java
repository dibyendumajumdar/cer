...
import org.redukti.cer.utils.UniqueTag;

import static org.redukti.cer.utils.UniqueTag.DOUBLE_MARK;
...
public final class Interpreter extends Icode implements Evaluator {
    ...
    public Object compile(
        ...
        CodeGenerator cgen = new CodeGenerator(Context.getCurrentContext());
    ...
    public String getPatchedStack(RhinoException ex, String nativeStackTrace) {
        String tag = "org.redukti.cer.runtime.Interpreter.interpretLoop";

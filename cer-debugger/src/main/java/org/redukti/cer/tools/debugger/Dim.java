...
package org.redukti.cer.tools.debugger;
...
public class Dim {
    ...
    private FunctionSource getFunctionSource(DebuggableScript fnOrScript) {
        ...
        if (fsource == null) {
            ...
            if (si == null) {
                if (!ScriptRuntime.isGeneratedScript(fnOrScript.getSourceName())) {
    ...
    private static String do_eval(Context cx, StackFrame frame, String expr) {
        ...
        try {
            ...
            Object result = script.call(cx, frame.scope, frame.thisObj, InterpreterConstants.emptyArgs);
    ...
    private static class DimIProxy implements ContextAction, ContextFactory.Listener, Debugger {
        ...
        @Override
        public DebugFrame getFrame(RuntimeContext rcx, DebuggableScript fnOrScript) {
            Context cx = (Context) rcx;
        ...
        @Override
        public void handleCompilationDone(RuntimeContext rcx, DebuggableScript fnOrScript, String source) {
            Context cx = (Context) rcx;
            if (type != IPROXY_DEBUG) Kit.codeBug();
    ...
    public static class StackFrame implements DebugFrame {
        ...
        @Override
        public void onEnter(RuntimeContext rcx, Scriptable scope, Scriptable thisObj, Object[] args) {
            Context cx = (Context) rcx;
        ...
        @Override
        public void onLineChange(RuntimeContext rcx, int lineno) {
            Context cx = (Context) rcx;
        ...
        @Override
        public void onExceptionThrown(RuntimeContext rcx, Throwable exception) {
            Context cx = (Context) rcx;
        ...
        @Override
        public void onExit(RuntimeContext rcx, boolean byThrow, Object resultOrException) {
            Context cx = (Context) rcx;
        ...
        @Override
        public void onDebuggerStatement(RuntimeContext rcx) {
            Context cx = (Context) rcx;
            dim.handleBreakpointHit(this, cx);
        }
    ...
    public static class SourceInfo {
        ...
        private SourceInfo(String source, DebuggableScript[] functions, String normilizedUrl) {
            ...
            for (int i = 0; i != N; ++i) {
                lineArrays[i] = Interpreter.getLineNumbers((InterpreterData) functions[i]);
            }

...
import org.redukti.cer.tools.shell.Global;
...
public class Main {
     ...
     * org.redukti.cer.tools.shell.Main} shell session.
     */
    public static void main(String[] args) {
        ...
        Global global = org.redukti.cer.tools.shell.Main.getGlobal();
        global.setIn(main.getIn());
        global.setOut(main.getOut());
        global.setErr(main.getErr());

        main.attachTo(org.redukti.cer.tools.shell.Main.shellContextFactory);
        ...
        org.redukti.cer.tools.shell.Main.exec(args);
    }

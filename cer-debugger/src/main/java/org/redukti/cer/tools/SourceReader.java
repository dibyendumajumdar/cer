...
package org.redukti.cer.tools;

import org.redukti.cer.commonjs.module.provider.ParsedContentType;
...
public class SourceReader {
    ...
    public static Object readFileOrUrl(String path, boolean convertToString, String defaultEncoding)
            throws IOException {
        URL url = toUrl(path);
        InputStream is = null;
        int capacityHint = 0;

...
public class NumberUtils {
    ...
    public static double stringPrefixToNumber(String s, int start, int radix) {
        return stringToNumber(s, start, s.length() - 1, radix, true);
    }

    public static double stringToNumber(String s, int start, int end, int radix) {
    ...
    private static double stringToNumber(
        ...
        if (sum > Limits.MAX_SAFE_INTEGER) {
            if (radix == 10) {
